...
//__________________________EXERCISES______________________________//
    ...
    public boolean equals(HashIntSet other) {
        ...
        if(size == other.size && containsAll(other)) {
            return true;
        }
